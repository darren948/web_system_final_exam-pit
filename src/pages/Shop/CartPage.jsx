                  ...
                  <div className="col-md-6 col-12">
                    <div className="calculate-shiping">
                      ...
                      <div className="outline-select">
                        <select>
                          <option value="volvo">Philippines (PH)</option>
                        </select>
                      ...
                      <div className="outline-select shipping-select">
                        <select>
                          ...
                          <option value="saab">Cagayan De Oro</option>
                          <option value="saab">Manila</option>
                          <option value="saab">Cebu</option>
                          <option value="saab">Davao</option>
                        </select>
                        <span className="select-icon">
                          <i className="icofont-rounded-down"></i>
                        </span>
